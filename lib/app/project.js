...
exports.create = function (dpath, data, cb) {
    ...
    data.app = {
        ...
        languages: true,
		columnSettings: {
			createTimestampLabel: 'createdAt',
			updateTimestampLabel: 'updatedAt',
			hidden: true, // Hide the timestamp fields, please configure preSave hook to auto fill the fields before save
			active: true
		}
    };
    ...
    fs.writeFileSync(path.join(dpath, 'settings.json'), JSON.stringify(defaultSettings, null, 4), 'utf8');
}
